...
<!-- <input type="checkbox" id="check"> -->
    ...
    <div class="buttons">
      <!-- <a href="apartment.html">
        <button class="btn">New Complaints</button>
      </a>
      <a href="staff_manager.html">
        <button class="btn">Old Complaints</button>
      </a>
    </div> -->
    ...
    <?php
        ...
        $sql = "SELECT complaint_date, description, category, status FROM complaints_table ;";
