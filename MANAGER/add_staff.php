...
<!-- <input type="checkbox" id="check"> -->
    ...
    <form action="add_staff.php" method="POST">
            <br><label for="add_staff_USERNAME">UserName*</label>
            <input type="number" name="add_staff_USERNAME" required><br><br>

            <label for="add_staff_PASSWORD">Password*</label>
            <input type="text" name="add_staff_PASSWORD" required><br><br>

            <label for="add_staff_FULL_NAME">Full Name*</label>
            <input type="text" name="add_staff_FULL_NAME" required><br><br>

            <label for="add_staff_phoneNumber">Phone Number* &nbsp &nbsp</label>
            <input type="text" name="add_staff_phoneNumber" required><br><br>

            <label for="add_staff_email">Email ID*</label>
            <input type="email" name="add_staff_email" required><br><br>
            ...
            <div class="center-button"> <!-- Added div for centering -->
                <br><input type="submit" name="save_staff" value="Save">
            </div>
...
if(isset($_POST['save_staff'])){
    ...
    $USERNAME = $_POST['add_staff_USERNAME'];
    $PASSWORD = $_POST['add_staff_PASSWORD'];
    $Full_name = $_POST['add_staff_FULL_NAME'];
    $phone_no = $_POST['add_staff_phoneNumber'];
    $email = $_POST['add_staff_email'];
    ...
    $stmt = $conn->prepare("INSERT INTO staff_table (username, password, full_name, phone_number, email) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $USERNAME, $PASSWORD, $Full_name, $phone_no, $email);

    if ($stmt->execute()) {
        echo "<script>alert('Staff Details Entered Successfully...!');
