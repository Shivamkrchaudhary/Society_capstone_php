...
if (isset($_POST['delete_staff'])) {
    $staff_username_to_delete = $_POST['staff_username'];
    ...
    $sql = "DELETE FROM staff_table WHERE username='$staff_username_to_delete'";
...
<!-- <input type="checkbox" id="check"> -->
    ...
    <?php
        if ($deleted) {
            echo "<script>alert('Staff Details Deleted Successfully...!');
    ...
    <form action="delete_staff.php" method="post">
            <label for="staff_username">Enter Staff username to Delete:</label> &nbsp
