...
<!-- <input type="checkbox" id="check"> -->
    ...
    <div class="container">
    <h1>Appartment Management</h1>
    <div class="buttons">
      <a href="add_resident.php">
        <button class="btn">Add Resident</button>
      </a>
      <a href="view_resident.php">
        <button class="btn">View Resident</button>
      </a>
      <a href="delete_resident.php">
        <button class="btn">Delete Resident</button>
      </a>
      <a href="appart_mang.php">
        <button class="btn">Appartment Status</button>
      </a>
    </div>
    <!-- dashboard area end -->
