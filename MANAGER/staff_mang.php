...
<!-- <input type="checkbox" id="check"> -->
    ...
    <div class="buttons">
      <a href="add_staff.php">
        <button class="btn">Add New Staff</button>
      </a>
      <a href="view_staff.php">
        <button class="btn">View Staff List</button>
      </a>
      <a href="delete_staff.php">
        <button class="btn">Delete Staff</button>
      </a>
      <a href="staff_mang.php">
        <button class="btn">Staff Payments</button>
      </a>
    </div>
    <!-- dashboard area end -->
