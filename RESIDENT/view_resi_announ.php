...
<head>
    ...
    <title>Resident Announcement</title>
...
<!-- <input type="checkbox" id="check"> -->
    ...
    <div class="container">
    <h1>View Resident Announcement</h1>
    <?php
        ...
        $sql = "SELECT announcement_date, title, description FROM announcement WHERE audience = 'resident';";
